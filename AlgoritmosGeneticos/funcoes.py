...
def cruzamento_ponto_simples(pai, mae):
    """Operador a função objetivo no problema das caixas binárias.
    ...
    Returns:
        Duas linhas, sendo que cada uma representa um filhos dos pais que foram os argumentos.
    """
...
def mutacao_cb(individuo):
    ...
    Return:
        Um individuo com umgene mutado.
    """
